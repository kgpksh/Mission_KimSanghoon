...
//                Member memberUser9ByFacebook = memberService.whenSocialLogin("FACEBOOK", "FACEBOOK__%s".formatted(facebookDevUserOAuthId)).getData();
                ...
                instaMemberService.connect(memberUser9, "insta_user9", "W");
                ...
                likeablePersonService.like(memberUser6, "insta_user9", 1).getData();
                likeablePersonService.like(memberUser7, "insta_user9", 3).getData();
                likeablePersonService.like(memberUser8, "insta_user9", 2).getData();

                likeablePersonService.like(memberUser3, "insta_user7", 1).getData();
                likeablePersonService.like(memberUser5, "insta_user7", 1).getData();
                likeablePersonService.like(memberUser3, "insta_user8", 1).getData();
            }
        };
    }
}